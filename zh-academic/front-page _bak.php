                    ...
                    <div class="listing">
                        <div class="listing-inner">
                            ...
                            <?php   $tax = 'groups';
                                  ...
                                  foreach ($tax_terms as $tax_term) {     
                                    ?>
                                <a href="<?php echo get_term_link( $tax_term->slug, $tax ); ?><?php //echo "&posttype=texthelpdoc"; ?> "> <li><?php echo $tax_term->name; ?></li></a>
                                    <?php $c+=1; if($c==6){break ;}
                                    }
                                ?>
                            </ul>
                   ...
                   <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 ">
                    <div class="listing">
                        <div class="listing-inner">
                         ...
                         <a href="<?php $url = get_site_url(); echo $url.'/webinar'; ?><?php// echo get_post_type_archive_link('videos'); ?>">View All</a>  
                    </div>
                </div>
                <!--Webinar section end-->
            </div>
