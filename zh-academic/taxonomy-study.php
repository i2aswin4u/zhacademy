<?php get_header('home');
$taxanomyis = get_query_var( 'study' );
$args = array(
  'study' => $taxanomyis
);
query_posts( $args );
    ...
    <div class="academy-top">
        ...
        <div class="banners">
            <div class="container-fluid">
                <div class="row">
                    <h1>
                        Courses - <?php $taxonomy = get_queried_object();
                        echo  $taxonomy->name; ?>
               </h1>
                    <p><?php $name = ot_get_option( 'course_category__archive_sub_title' ); if($name){ echo $name; } else {echo "Learn the simplicity & flexibility of the Blue EHS .
                        Understand how it adapts to the way you practice your way.";}?></option>
            ...
            <div class="row ">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                   
                   <div class="head-bottom">
                        ...
                        <a href="<?php echo get_site_url(); ?>/courses">
                            Courses 
                        </a>
                        <i class="fa fa-angle-double-right"></i>
                        <a href="">
        ...
        <div class="row ">
            <div class="bannerbtm-txtouter">
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 academy-borderoutr zh_faq_new">
                    ...
                    <a href="<?php echo get_site_url(); ?>/courses/" class="btn btn-default"> Back </a>
                </div>																	
            </div>
                <!--side bar --> 
