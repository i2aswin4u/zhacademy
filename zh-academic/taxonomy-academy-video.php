<?php get_header('home');
$_SESSION["academy"] = "video";
?>
<!-- File : taxonomy-academy-video.php-->
                                                    ...
                                                    <div class="video-sm">
                                                        <?php
                                                            if ( has_post_thumbnail() ) {
                                                                    ...
                                                                    ?>  <a href="<?php the_permalink();?>"><img src="<?php bloginfo('template_directory');?>/img/video-sm.jpg" class="img-responsive"></a> <?php 
                                                            }
                                                            ?>                                                                                                      
