...
?>
 <!--start of new design-->
 <!-- File : taxonomy-academy-help-documents.php-->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 reporting">
                                            <div class="content-section">
                                                <?php                                                                                                                                                  
                                                   $destname = get_term_by('slug',$_SESSION["modules"],'groups'); 
                                                   $id_term  = $destname->term_taxonomy_id;                                                   
                                                   $term = get_term( $id_term, 'modules' );
                                                   $term_meta = get_option("taxonomy_$id_term");       
                                                ?>
                                                <h3 class="line"><span><i class="fa <?php if ($term_meta[img]) {  echo $term_meta[img]; } else {  echo 'fa-cogs'; } ?>"></i> <?php echo $_SESSION['modules']; // echo $term->name; ?></span></h3>
...
//                                                      'groups'         => $category->slug,
                                                        'groups'         => $_SESSION["modules"],
                                                        'post_status'    => 'publish',
                                                        'posts_per_page' => -1,
                                                    );                               
                                                    $the_query_help_docs = new WP_Query($args);     
